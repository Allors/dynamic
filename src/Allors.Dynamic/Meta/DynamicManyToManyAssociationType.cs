namespace Allors.Dynamic.Meta
{
    ...
    {
        internal DynamicManyToManyAssociationType(DynamicObjectType objectType, DynamicManyToManyRoleType roleType, string singularName, string pluralName, string name)
        {
